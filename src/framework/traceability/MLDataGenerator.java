...
public class MLDataGenerator 
{
	...
	public List<Relation> getRelationDataInstanceDetails(String path) 
	{
		...
		try 
		{
			for(int i = 0; i < list.size(); i++) 
			{
				...
				list.get(i).setSourceElement(new framework.artefactRepresentation.Element
						(sourceNode.getChildNodes().item(1).getTextContent(), "", 
								handler.getDataKeyValue(sourceNode, GraphMLProcessor.TYPE_DATA_KEY_VALUE)));

				list.get(i).setTargetElement(new framework.artefactRepresentation.Element
	...
	/*
	  // 1. MazeSolver
		String relationsFilePath = "C:/Users/Ildi/Dropbox/PhD/SharedBackup/Evaluation/MazeSolver/Evaluation Files/RelationsFile.xml";
		//OLD PATH String relationsFilePath2 = "C:/Users/Ildi/Dropbox/PhD/SharedBackup/Evaluation/JGAP/RelationsFile.xml";
		
		// 2. JGAP
		String relationsFilePath2 = "C:/Users/Ildi/Dropbox/PhD/SharedBackup/Traceability/ML-2/GeneratedCSV/UnitTestIds/RelationsFile.xml";
		//String relationsFilePath3 = "C:/Users/Ildi/Dropbox/PhD/SharedBackup/Evaluation/MazeSolver/Evaluation Files/RelationsFileForTestSet.xml";
		//String relationsFilePath4 = "C:/Users/Ildi/Dropbox/PhD/SharedBackup/Evaluation/JGAP/RelationsFileForTestSet.xml";

		// 3. Neo4j
		String relationsFilePath3 = "C:/Users/Ildi/Dropbox/PhD/SharedBackup/Evaluation/Neo4j/RelationsFile.xml";
	
		// 4. MyRobotLab
		String relationsFilePath4 = "C:/Users/Ildi/Dropbox/PhD/SharedBackup/Evaluation/MyRobotLab/RelationsFile.xml";
		
		// 5. Java Binary Parser
		String relationsFilePath5 = "C:/Users/Ildi/Dropbox/PhD/SharedBackup/Evaluation/BinaryBlockParser/RelationsFile.xml";
		
		// 6. Titan
		String relationsFilePath6 = "C:/Users/Ildi/Dropbox/PhD/SharedBackup/Evaluation/Titan/RelationsFile.xml";
		String csv = "C:/Users/Ildi/Dropbox/PhD/SharedBackup/Traceability/ML-2/GeneratedCSV/2310/Related_Binary5.csv";
		*/
	...
	{
		MLDataGenerator generate = new MLDataGenerator();
		generate.generateTestData("C:\\Users\\Ildi\\Desktop\\r.xml", "C:\\Users\\Ildi\\Desktop\\test.csv");
		//generate.generateRelatedDataAllFeatures();
		//generate.generateNonRelatedDataAllFeatures();
		//generate.generateRelatedTestDataAllFeatures();
		//generate.generateNonRelatedTestDataAllFeatures();
		
		// Generated related data for MAZE and for JGAP
		// Generate related data for Neo4j using architecture and source code, source code and unit test artefacts
	}
}
