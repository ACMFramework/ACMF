 ...
 *
 */
public class ChangeDetectionPerformanceTests 
{
	/**
	 * 
	 */
	 ...
	 * 
	 */
	public ChangeDetectionPerformanceTests() 
	{
	...
	public List<ChangeData> doEditChangeDetection() 
	{
		...
		// Measure performance of the change identification algorithm
		long startTime = System.nanoTime();
		identifier.Execute();
		long endTime = System.nanoTime();
		long changeIdentificationDuration = endTime - startTime;
		System.out.println("Duration of change identification: "+ changeIdentificationDuration /1E9);
		...
		if(!adds.isEmpty()) 
		{
			...
			for(int i = 0; i < adds.size(); i++) 
			{
				...
				System.out.println("These are the updated adds: " + adds);
			}
	...
	{
		ChangeDetectionPerformanceTests m = new ChangeDetectionPerformanceTests();
		long startTime = System.nanoTime();
		m.manageChangeDetection();
		long endTime = System.nanoTime();
		long changeDetectionDuration = endTime - startTime;
		System.out.println("Duration of change detection: "+ changeDetectionDuration /1E9);
	}
}
